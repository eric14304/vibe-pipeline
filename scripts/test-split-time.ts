...
## 參考
參考 \`.claude/skills/vibe-pipeline/SKILL.md\`(產品定位)、\`vibe-pipeline-frontend\` SKILL(src/ 約定)、\`vibe-pipeline-backend\` SKILL(server/ 職責邊界)、\`vibe-pipeline-e2e\` SKILL(e2e 不可破壞語意)。`,
  mode: "iter" as const,
};
