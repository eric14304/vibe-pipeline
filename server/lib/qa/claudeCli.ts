...
export async function runTurn({
  ...
  // MCP servers / slash commands 干擾。砍 setting-sources / mcp / slash-commands 後 cold start ~快 1-2 秒、
  // 1h cache_creation tokens 從 ~19500 降到 ~7000(節省 ~60% input cost)。量測見 .perf-bench/。
  //
