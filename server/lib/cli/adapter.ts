...
export type TaskClass = "qa" | "runner" | "split" | "merge";
...
// adapter spawn 結果:回 Bun Subprocess 或同形狀(stdout/stderr/exited/exitCode/stdin?)
export type SpawnedProcess = Bun.Subprocess;
