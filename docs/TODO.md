...
### 6. Backend self-heal / health watchdog
...
### 7. `vbpl pipeline delete` 一併清 worktree+branch
...
### 8. Mockup-driven pixel polish 機制
...
### 9. Worktree staleness 警告 / auto-sync
...
### 11. Web UI 不該自動 fire `pipeline.run`(audit 抓到)
...
### 13. `ticketWatcher` disk reconcile 是 happy accident,該設計化
